...
class Social_Login:
    ...
    def __init__(self, poco):
        ...
        self.Join_Network_Password_TextBox = Template(Basic_path("tpl1707464989065.png"), record_pos=(-0.185, 0.028),
                                                      resolution=(720, 1280))
    ...
    def check_the_text_of_benefits_of_free_account_page(self):
        ...
        b = self.poco(
            textMatches=".*Design custom labels from scratch and print using the ZSB Label Designer on your PC or Mac.*").exists()
    ...
    def continue_in_facebook(self):
        sleep(2)
        self.poco(textMatches=".*Continue as.*").click()
