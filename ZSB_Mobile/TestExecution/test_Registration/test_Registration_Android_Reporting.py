...
def test_Registration_TestcaseID_45855():
    ...
    try:
        ...
        insert_step(execID, leftId["45855"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45855"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
...
def test_Registration_TestcaseID_45859():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45859"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45859"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Registration_TestcaseID_45860():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45860"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45860"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Registration_TestcaseID_45861():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45861"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45861"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Registration_TestcaseID_45863():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45863"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45863"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Registration_TestcaseID_45868():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45868"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45868"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Registration_TestcaseID_45869():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45869"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45869"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Registration_TestcaseID_45862():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45862"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45862"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Smoke_Test_TestcaseID_45877():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45877"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45877"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
# # ## """"""""""""""""""""""""""""""End"""""""""""""""""""""""""""""""""""""""""""""""""""
#
