...
#     pass
#     common_method.show_message("Turn off printer associated with the account zebra02.swdvt@gmail.com and wait for it to show offline in account zebra02.swdvt@gmail.com")
...
#     data_sources_page.check_if_printer_info_is_shown_when_printer_offline()
...
#     data_sources_page.check_if_print_page_appears()
...
#     data_sources_page.check_if_print_count_changed_if_printer_offline(remaining_label_count, new_label_count)
#     data_sources_page.clickBackArrow()
#     data_sources_page.check_if_returned_to_my_designs_page_after_clicking_back_arrow()
#     login_page.click_Menu_HamburgerICN()
...
#     common_method.show_message("Turn on printer associated with the account zebra02.swdvt@gmail.com and wait for sometime to reflect online status")
...
#     print(design_last_print_date, "\n", data_sources_page.get_current_date())
...
#     template_management_page.scroll_up_to_print_preview()
...
#     common_method.show_message("Check all the link column values are correct and change accordingly when navigating to previous and next labels and the preview image is correct accordingly.")
#     common_method.show_message("Check the table info in label range is the same as your contact info and return to print preview page.")
#     data_sources_page.scroll_till_print()
...
#     template_management_page_1.wait_for_element_appearance_name_matches_all("Print complete", 60)
#     sleep(3)
#     common_method.show_message("Login to google account(zebra03.swdvt@gmail.com-Zebra#123456789) on a different device and go to google contacts and delete one of the existing contact and modify the data of one of the contact and create a new contact.")
#     common_method.tearDown()
#     data_sources_page.checkIfOnHomePage()
...
#         "Update the 46021.xlsx file present in google drive by downloading it adding more rows or columns and them replace the file in google drive with the updated version. It is present in the account zebra03.swdvt@gmail.com")
#     common_method.show_message(
