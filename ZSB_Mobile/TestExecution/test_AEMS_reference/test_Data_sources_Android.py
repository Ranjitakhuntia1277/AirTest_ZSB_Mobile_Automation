...
#         3: [3, 'Check user is navigated to "Login with username" page. Enter login name (E.g MW12345) with correct password and click Sign in button. This time sign in with Zebra account.'],
...
#         7: [7, 'Cloud Service Sign in page will open and let user select which service to login'],
#         8: [8, 'Click Sign in with Microsoft'],
#         9: [9,
#              'Select two or three supported files to upload, Check Files are linked without issue, Select the files linked from OneDrive and Remove'],
#         10: [10, 'Check the linked files are removed from My Data page'],
#         11: [11, 'Repeat step 7 to step 13 but to link Google Drive file'],
#         12: [12, 'Click on the hamburger icon follow by Settings and click Log out button'],
#         13: [13,
