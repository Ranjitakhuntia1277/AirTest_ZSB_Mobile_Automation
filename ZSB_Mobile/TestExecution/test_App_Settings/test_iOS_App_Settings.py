...
# sleep(3)
# app_settings_page_ios.Home_text_is_present_on_homepage()
# #     common_method.savePassResult(errors, "45689")
# # except Exception as e:
# #     common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# #     common_method.savePassResult(errors, "45690")
# # except Exception as e:
# #     common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
#
# sleep(2)
# # common_method.savePassResult(errors, "45691")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# app_settings_page_ios.click_Save_Exit_Btn()
# sleep(3)
# # common_method.savePassResult(errors, "45692")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# # common_method.savePassResult(errors, "45705")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# # common_method.savePassResult(errors, "47810")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# sleep(3)
# # common_method.savePassResult(errors, "47820")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# app_settings_page_ios.Is_Present_User_Settings_Text()
# #     common_method.savePassResult(errors, "47825")
# # except Exception as e:
# #     common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# # common_method.savePassResult(errors, "47879")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# add_a_printer_page_ios.click_Printer_LED_Guide_Done_Btn()
# add_a_printer_page_ios.Click_Next_Button()
# # common_method.savePassResult(errors, "47880")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# # common_method.savePassResult(errors, "47911")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# #    common_method.savePassResult(errors, "47914")
# # except Exception as e:
# #    common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# # common_method.savePassResult(errors, "47915")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# #     common_method.savePassResult(errors, "47923")
# # except Exception as e:
# #     common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# # common_method.savePassResult(errors, "47956")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
app_settings_page_ios.click_Manage_Networks_Btn()
app_settings_page_ios.click_Keyboard_back_Icon()
# common_method.savePassResult(errors, "49665")
# except Exception as e:
# common_method.saveError(errors, e)
"""stop the app"""
common_method.Stop_The_iOSApp()
...
# # app_settings_page_ios.click_Change_Password_Btn()
# # app_settings_page_ios.Verify_Password_Recovery_Text_Is_Displaying()
# # common_method.savePassResult(errors, "49960")
# # except Exception as e:
# #     common_method.saveError(errors, e)
# #     """stop the app"""
# common_method.Stop_The_iOSApp()
...
# common_method.savePassResult(errors, "49961")
# except Exception as e:
# common_method.saveError(errors, e)
"""stop the app"""
common_method.Stop_The_iOSApp()
...
""""Verify Printed successfully text"""
app_settings_page_ios.Verify_Printed_Successfully_Text()
#     common_method.savePassResult(errors, "50031")
# except Exception as e:
#     common_method.saveError(errors, e)
"""stop the app"""
common_method.Stop_The_iOSApp()
...
app_settings_page_ios.Verify_Wifi_Tab_Text()
# common_method.savePassResult(errors, "50333")
# except Exception as e:
# common_method.saveError(errors, e)
"""stop the app"""
common_method.Stop_The_iOSApp()
...
app_settings_page_ios.Scroll_Till_Notification_Settings_Tab()
...
"""click on save & exit button"""
app_settings_page_ios.click_Save_Exit_Btn()
# common_method.savePassResult(errors, "51702")
# except Exception as e:
# common_method.saveError(errors, e)
"""stop the app"""
common_method.Stop_The_iOSApp()
...
""""click user photo remove image"""
app_settings_page_ios.click_User_Photo_Remove_Image()
#     common_method.savePassResult(errors, "51705")
# except Exception as e:
#     common_method.saveError(errors, e)
"""stop the app"""
common_method.Stop_The_iOSApp()
...
app_settings_page_ios.Home_text_is_present_on_homepage()
#     common_method.savePassResult(errors, "51788")
# except Exception as e:
#     common_method.saveError(errors, e)
# """stop the app"""
common_method.Stop_The_iOSApp()
...
# # common_method.savePassResult(errors, "47881")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
...
# # common_method.savePassResult(errors, "47928")
# # except Exception as e:
# # common_method.saveError(errors, e)
# """stop the app"""
# common_method.Stop_The_iOSApp()
