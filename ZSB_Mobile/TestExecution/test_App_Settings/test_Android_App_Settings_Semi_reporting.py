...
def test_AppSettings_TestcaseID_47913():
    ...
    try:
        ...
        insert_step(execID, leftId["47913"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["47913"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
...
def test_AppSettings_TestcaseID_50031():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["50031"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["50031"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_AppSettings_TestcaseID_49709():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["49709"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["49709"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_AppSettings_TestcaseID_49711():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["49711"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["49711"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_AppSettings_TestcaseID_50326():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["50326"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["50326"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_AppSettings_TestcaseID_45688():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45688"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45688"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Smoke_Test_TestcaseID_45882():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45882"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45882"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
...
def test_Smoke_Test_TestcaseID_45900():
    ...
    try:
        ...
        exec_time = (time.time() - start_time) / 60
        insert_step(execID, leftId["45900"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Pass", exec_time)
        stepId += 1
        ...
        insert_step(execID, leftId["45900"], test_steps[stepId][0], stepId, test_steps[stepId][1], "Fail", 0)
        raise Exception(str(e))
