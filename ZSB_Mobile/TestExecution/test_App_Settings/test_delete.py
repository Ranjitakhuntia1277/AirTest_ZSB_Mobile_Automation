...
def test_AppSettings_TestcaseID_47918():
    ...
    test_steps = {
        1: ["Install ZSB Series app"],
        2: ["Launch the app"],
        3: ["Select 'Only this time' from all (Location, nearby) permission pop up"],
        4: ["Close and re-launch the app. Check that all permissions should ask for permission every time if user has opted to ask for every time or denied."]
    }
